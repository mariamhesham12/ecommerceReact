...
export default function Login() {
  ...
  return (
    <div className="py-20 mb-[100px]">
       ...
       <h1 className="text-main-color text-2xl font-bold mt-5">Login Now:</h1>
...
<Link to={"/forgetPassword"} className="hover:text-main-color transition-all duration-700 font-bold">Forget Password?</Link>
