...
export default function ForgetPassword() {
    ...
    async function SendVerificationCodeToEmail(values){
        setLoading(true)
        setLoaading(true)
        try {
    ...
    const formik=useFormik({
        ...
        validationSchema,
        onSubmit:SendVerificationCodeToEmail
    })
  ...
  return (
    <div className="py-20 mb-[100px]">
        ...
        <p className="text-xl font-bold mt-5">Please Enter your Email to send you a verification code:</p>
